package com.getripay_pos.utils;
...
import com.getripay_pos.DeviceHelper;
...
public class EmvUtil {
    ...
    public static Bundle getInitTermConfig() {
        ...
        bundle.putByteArray(EmvTermCfgConstrants.PURE_POSIO, new byte[]{(byte) 0x03, (byte) 0x56});
        bundle.putByteArray(EmvTermCfgConstrants.PURE_CONTACTLESS_CAPABILITY, new byte[]{(byte) 0x03, (byte) 0x56});

        return bundle;
    }
    public static Bundle getTransBundle(String amount, String cashBackAmt) {
        return getInitBundleValue(-1, amount, cashBackAmt);
    }
    ...
    public static Bundle getInitBundleValue(int channelType, String amount, String cashBackAmt) {
        ...
        bundle.putInt(EmvTransDataConstrants.KERNEL_MODE, 0x00);
        ...
        bundle.putBoolean("K21LogEnable", true);
